...
public sealed class HydroAsetekDevice : DeviceBase
{
    ...
    public HydroAsetekDevice(IAsetekDeviceProxy device, IDeviceGuardManager guardManager, ILogger logger, bool isPassive = false)
        : base(logger)
    {
        _device = device;
